...
func newNote(db *gorm.DB, opts ...gen.DOOption) note {
	...
	_note.noteDo.UseModel(&domain.Note{})
...
type INoteDo interface {
	...
	Unscoped() INoteDo
	Create(values ...*domain.Note) error
	CreateInBatches(values []*domain.Note, batchSize int) error
	Save(values ...*domain.Note) error
	First() (*domain.Note, error)
	Take() (*domain.Note, error)
	Last() (*domain.Note, error)
	Find() ([]*domain.Note, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Note, err error)
	FindInBatches(result *[]*domain.Note, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*domain.Note) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*domain.Note, error)
	FirstOrCreate() (*domain.Note, error)
	FindByPage(offset int, limit int) (result []*domain.Note, count int64, err error)
...
func (n noteDo) Create(values ...*domain.Note) error {
	if len(values) == 0 {
		return nil
	}
...
func (n noteDo) CreateInBatches(values []*domain.Note, batchSize int) error {
	return n.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (n noteDo) Save(values ...*domain.Note) error {
	if len(values) == 0 {
		return nil
	}
...
func (n noteDo) First() (*domain.Note, error) {
...
func (n noteDo) Take() (*domain.Note, error) {
...
func (n noteDo) Last() (*domain.Note, error) {
...
func (n noteDo) Find() ([]*domain.Note, error) {
	result, err := n.DO.Find()
	return result.([]*domain.Note), err
}

func (n noteDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Note, err error) {
	buf := make([]*domain.Note, 0, batchSize)
...
func (n noteDo) FindInBatches(result *[]*domain.Note, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (n noteDo) FirstOrInit() (*domain.Note, error) {
...
func (n noteDo) FirstOrCreate() (*domain.Note, error) {
...
func (n noteDo) FindByPage(offset int, limit int) (result []*domain.Note, count int64, err error) {
...
func (n noteDo) Delete(models ...*domain.Note) (result gen.ResultInfo, err error) {
