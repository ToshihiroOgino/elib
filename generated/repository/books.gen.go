...
func newBook(db *gorm.DB, opts ...gen.DOOption) book {
	...
	_book.UserID = field.NewString(tableName, "user_id")
	_book.Title = field.NewString(tableName, "title")
	_book.Author = field.NewString(tableName, "author")
	_book.Provider = field.NewInt32(tableName, "provider")
	_book.Category = field.NewInt32(tableName, "category")
...
func (b *book) updateTableName(table string) *book {
	...
	b.Category = field.NewInt32(table, "category")
